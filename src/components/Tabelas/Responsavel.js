...
function TabelaResponsavel() {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`http://localhost:8000/responsavel/${postoId}/dadosPerfil`);
            const resposta = await axios.get(`http://localhost:8000/responsavel/${postoId}/dadosPerfil`);
